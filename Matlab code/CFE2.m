function [licznik,mianownik] = CFE(T,alpha,metodaDyskretyzacji)
...
%zwraca licznik i mianownik transmitancji w przestrzeni Z w postaci 
...
k = ((1+metodaDyskretyzacji)/T)^alpha;
    ...
    a3=1;
    mianownik=[a0 a1 a2 a3];
    licznik = k*[b0 b1 b2 b3];
